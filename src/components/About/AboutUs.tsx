      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <h2 className="text-4xl font-extrabold mb-4">
            Our <span className="text-purple-600">Architectural</span> Journey
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="border-t-4 border-yellow-400 pt-4">
              <h3 className="text-2xl font-bold mb-1">50+ years</h3>
              <p className="text-gray-500 text-base">
                of shaping architectural landscapes
              </p>
            </div>
            <div className="border-t-4 border-yellow-400 pt-4">
              <h3 className="text-2xl font-bold mb-1">100+ Projects</h3>
              <p className="text-gray-500 text-base">
                successfully delivered with excellence
              </p>
            </div>
            <div className="border-t-4 border-yellow-400 pt-4">
              <h3 className="text-2xl font-bold mb-1">20+ Awards</h3>
              <p className="text-gray-500 text-base">
                won, underscoring our dedication to innovative
              </p>
            </div>
            <div className="border-t-4 border-yellow-400 pt-4">
              <h3 className="text-2xl font-bold mb-1">99% Success</h3>
              <p className="text-gray-500 text-base">
